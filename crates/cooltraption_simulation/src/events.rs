...
use crate::{simulation_state::SimulationState, action::ActionPacket};
...
impl<'a> EventFamily for MutEvent<'a, SimulationState>{
    type Event<'e> = MutEvent<'e, SimulationState>;
}

impl<'a> EventFamily for Event<'a, ActionPacket>{
    type Event<'e> = Event<'e, ActionPacket>;
}
